...
- [ ] Gantt — arrastrar para reprogramar: agregar asas en los extremos de cada barra (mismo mecanismo que ya existe en la vista Semana) para modificar las fechas de inicio/fin de la tarea directamente desde el Gantt
- [ ] Gantt — dibujar flechas de dependencia: en vez de solo el texto "Bloqueada por...", dibujar una línea/flecha visual conectando el final de la tarea bloqueante con el inicio de la bloqueada
