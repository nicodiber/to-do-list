...
- **Tipos de vista**: visualizadores (Hoy, Agenda, Semana, Gantt, Tabla, Estadísticas), ABMs (Tareas, Categorías, Ubicaciones, Metas, Personas, Mejoras, con ventanas modales para crear y editar), asistentes (Revisar mi día) y configuración/integraciones (Drive, Calendar, Configuraciones).
